...
from com.mhire.app.services.combined.combined_router import router as combined_router
...
# Register routers
# app.include_router(schedule_builder_router)  # Commented out to hide from Swagger UI
# app.include_router(sentiment_toolkit_router)  # Commented out to prevent endpoint conflict
